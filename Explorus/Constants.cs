...
namespace Explorus
{
    internal static class Constants
    {
        ...
        public static readonly Models.Sprites[,] level_1 =
        {
            ...
            {Sprites.wall, Sprites.empty,              Sprites.empty, Sprites.empty, Sprites.empty, Sprites.wall,  Sprites.empty, Sprites.empty, Sprites.empty,Sprites.empty,           Sprites.empty, Sprites.wall,  Sprites.empty, Sprites.empty, Sprites.empty, Sprites.empty,              Sprites.wall},
            ...
            {Sprites.wall, Sprites.empty,Sprites.wall,  Sprites.empty, Sprites.empty, Sprites.empty, Sprites.empty, Sprites.empty, Sprites.empty,              Sprites.empty,           Sprites.empty, Sprites.empty, Sprites.empty, Sprites.empty, Sprites.wall,  Sprites.empty,Sprites.wall},
